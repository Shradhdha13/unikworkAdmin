            ...
            <div class="container mobile-app cross-sec">
                <div class="row align-items-center">
                    <div class="col col-md-6 wow fadeInUp cross-alter-content">
                        ...
                        <a href="<?php echo e(route('contact-us')); ?>" class="btn button-primary mt-0">Contact Us</a>
                    </div>
                    <div class="col col-md-6 text-right wow fadeInUp">
                        <img src="<?php echo e(asset('images/case-studies.png')); ?>" widht="685px" height="100%" alt="case study unikwork">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row work-sec">
                    ...
                    <div class="work-content-sec d-lg-flex">
                        <div class="col-lg-6 col-12 work-img p-0">
                            <img src="<?php echo e(asset('images/lojong.png')); ?>" widht="704px" height="100%" alt="unikwork">
                        </div>
                        <div class="col-lg-6 col-12 work-main">
                            <div class="work-content">
                                ...
                                <div class="work-store">
                                    <a href="<?php echo e(URL::to('https://apps.apple.com/us/app/lojong-guided-meditation/id1292587933')); ?>" target="_blank"><img src="<?php echo e(asset('images/apple-store.png')); ?>" alt="image"></a>
                                    <a href="<?php echo e(URL::to('https://play.google.com/store/apps/details?id=br.com.lojong&hl=en_IN&gl=US')); ?>" target="_blank"><img src="<?php echo e(asset('images/playstore.png')); ?>" alt="image"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row work-sec carblip-work mb-5">
                    ...
                    <div class="work-content-sec carblip-sec d-lg-flex">
                        <div class="col-lg-6 col-12 work-main">
                            <div class="work-content">
                                <a href="<?php echo e(route('carblip')); ?>" class="d-block">
                                ...
                                <div class="work-store">
                                    <a href="<?php echo e(URL::to('https://apps.apple.com/us/app/carblip-your-car-delivered/id1362042544')); ?>" target="_blank"><img src="<?php echo e(asset('images/apple-store.png')); ?>" alt="image"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12 work-img p-0">
                            <img src="<?php echo e(asset('images/carb-lip.png')); ?>" widht="704px" height="100%" alt="unikwork">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.apps',['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/case-studies.blade.php ENDPATH**/ ?>