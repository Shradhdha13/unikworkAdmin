            ...
            <div class="container pb-5">
                <div class="row align-items-center">
                    <div class="col-12 mb-4 p-0 p-sm-3 wow fadeInUp">
                        <img src="<?php echo e(asset('images/quick-detail.png')); ?>" width="855px" height="100%" alt="case study unikwork">
                    </div>
...
<?php echo $__env->make('layouts.apps',['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/quick.blade.php ENDPATH**/ ?>