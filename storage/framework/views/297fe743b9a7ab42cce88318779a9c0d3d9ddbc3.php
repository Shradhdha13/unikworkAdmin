...
<header id="header" class="fixed-top">
    <div class="container-fluid d-flex align-items-center justify-content-between p-0">
        <a href="<?php echo e(\Illuminate\Support\Facades\URL::to('/')); ?>" alt="unikwork" class="logo">
        ...
        <nav class="navbar navbar-expand-md navbar-light">
            ...
            <div class="navbar-collapse collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto py-4 py-md-0">
                    ...
                    <li class="nav-item dropdown <?php echo e(Request::is('services') || Request::is('app-development') || Request::is('web-development') || Request::is('ui-ux') || Request::is('internet-of-things') || Request::is('development-operations') || Request::is('quality-assurance') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\unikworkAdmin\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>