    ...
    <main id="careers">
        ...
        <section class="banner-sec">
            <div class="container-fluid">
                <div class="container">
                    <h1><?php echo e(!empty($requirement->technology) ? $requirement->technology : ''); ?></h1>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-12">
                        <div class="accordion">
                            <div class="company-req row">
                                <div class="col-md-6">
                                    <h4>Qualification</h4>
                                    <p><?php echo e(!empty($requirement->qualification) ? $requirement->qualification : ''); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <h4>Location</h4>
                                    <p><?php echo e(!empty($requirement->location) ?  $requirement->location : ''); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <h4>Salary range</h4>
                                    <p><?php echo e(!empty($requirement->salary) ? $requirement->salary : ''); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <h4>Experience/Seniority level</h4>
                                    <p><?php echo e(!empty($requirement->experience) ?  $requirement->experience : ''); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <h4>Job Time</h4>
                                    <p><?php echo e(!empty($requirement->time) ? $requirement->time : ''); ?></p>
                                </div>
                            </div>
                            <h4 class="text-center my-4">Requirements / Your Skills</h4>
                            <div class="req-skill">
                                <div class="icon-points">
                                    <?php $__currentLoopData = json_decode($requirement->requirement); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <input type="hidden" name="requirement_id" value="<?php echo e(encrypt($requirement->id)); ?>" id="requirement_id">
                ...
                <div class="apply-position-form">
                    ...
                    <div class="row align-items-center">
                        <div class="col col-sm-12">
                            ...
                            <form class="apply-position" id="apply_position" method="post" action="<?php echo e(route('add-careers')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label class="error">
                                                <?php echo e($errors->first('expected_salary')); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control file-upload" data-error="cv-upload-error" id="cv" name="cv">
                                            <div class="your-cv"></div>
                                            <label class="error">
                                                <?php echo e($errors->first('cv')); ?>

                                            </label>
                                            <label class="error cv-upload-error"></label>
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="text-center">
                                    <button type="submit" class="btn button-primary mt-4 apply-now" disabled>Apply now</button>
                                </div>
                    ...
                    <div class="modal-body container">
                        <div class="row align-items-center text-center">
                            <div class="col-12 p-0">
                                ...
                                <img src="<?php echo e(asset('images/thankyou.gif')); ?>" alt="Thank You" class="gif-img" />
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.apps',['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unikworkAdmin\resources\views/career-details.blade.php ENDPATH**/ ?>