...
<div class="form-group">
    ...
    <small id="category_slug_help" class="form-text text-muted">
        Letters, numbers, dash only. The slug i.e. <?php echo e(route("blogetc.view_category", "")); ?>/<u><em>this_part</em></u>.
...
<div class="form-group">
    ...
    <textarea name="category_description"
              class="form-control"
              id="category_description"><?php echo e(old("category_description",$category->category_description)); ?></textarea>
</div>

<script>
  SHOULD_AUTO_GEN_SLUG = document.getElementById('category_slug').value.length < 1;
</script>
<?php /**PATH /var/www/html/vendor/webdevetc/blogetc/src/Views/blogetc_admin/categories/form.blade.php ENDPATH**/ ?>