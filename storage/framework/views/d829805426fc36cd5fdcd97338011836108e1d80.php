            ...
            <div class="container cross-sec">
                <div class="row align-items-center">
                    <div class="col col-md-6 cross-alter-content">
                        <img src="<?php echo e(asset('images/about/we-empower-icon.svg')); ?>" widht="100px" height="100px" alt="about unikwork" class="illustration-sec-icon wow fadeInUp">
                        ...
                        <a href="<?php echo e(route('careers')); ?>" class="btn button-primary mt-0 wow fadeInUp">Become Part Of Unikwork</a>
                    </div>
                    <div class="col col-md-6">
                        <img src="<?php echo e(asset('images/about/we-empower.png')); ?>" widht="685px" height="100%" alt="about unikwork" class="wow fadeInUp">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container cross-sec">
                <div class="row align-items-center">
                    <div class="col col-sm-12 col-xl-6 who-we-are">
                        <img src="<?php echo e(asset('images/about/about-us-icon.svg')); ?>" widht="100px" height="100px" alt="about unikwork" class="illustration-sec-icon">
                        ...
                        <a href="<?php echo e(route('careers')); ?>" class="btn button-primary mt-0 wow fadeInUp">Let Us Help You Go Digital</a>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row review-sec">
                    ...
                    <div class="col col-12 text-center mt-5">
                        <div>
                            <a href="<?php echo e(route('contact-us')); ?>" class="btn button-primary">The Talent That Drives Us</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="parallax-sec section-space">
            <div class="container-fluid">
                <div class="parallax-img">
                    <div>
                        <img src="<?php echo e(asset('images/about/parallax-img-1.png')); ?>" widht="373px" height="100%" alt="about unikwork"/>
                    </div>

                    <div >
                        <img src="<?php echo e(asset('images/about/parallax-img-2.png')); ?>" widht="373px" height="100px" alt="about unikwork"/>
                    </div>

                    <div class="horizontal">
                        <img src="<?php echo e(asset('images/about/parallax-img-3.png')); ?>" widht="755px" height="100px" alt="about unikwork"/>
                    </div>

                    <div>
                        <img src="<?php echo e(asset('images/about/parallax-img-4.png')); ?>" widht="373px" height="100%" alt="about unikwork"/>
                    </div>

                    <div>
                        <img src="<?php echo e(asset('images/about/parallax-img-5.png')); ?>" widht="373px" height="100%" alt="about unikwork"/>
                    </div>

                    <div class="horizontal">
                        <img src="<?php echo e(asset('images/about/parallax-img-6.png')); ?>" widht="755px" height="100%" alt="about unikwork"/>
                    </div>

                    <div>
                        <img src="<?php echo e(asset('images/about/parallax-img-7.png')); ?>" widht="373px" height="100%" alt="about unikwork"/>
                    </div>

                    <div>
                        <img src="<?php echo e(asset('images/about/parallax-img-8.png')); ?>" widht="373px" height="100%" alt="about unikwork"/>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    ...
                    <div class="row d-block d-md-flex">
                        <div class="col col-md-4 management-team-content text-center">
                            <img src="<?php echo e(asset('images/about/nirav.jpeg')); ?>" widht="150px" height="150px" alt="about unikwork"/>
                            <h4>Nirav Vavadiya</h4>
                            <span>Director</span>
                        </div>
                        <div class="col col-md-4 management-team-content text-center">
                            <img src="<?php echo e(asset('images/about/sagar.jpeg')); ?>" widht="150px" height="150px" alt="about unikwork"/>
                            <h4>Sagar Radadiya</h4>
                            <span>Head of Technology</span>
                        </div>
                        <div class="col col-md-4 management-team-content text-center">
                            <img src="<?php echo e(asset('images/about/priya.jpeg')); ?>" widht="150px" height="150px" alt="about unikwork"/>
                            <h4>Priya Dhola</h4>
            ...
            <div class="container cross-sec">
                <div class="row align-items-center">
                    <div class="col col-md-6 mb-4 mb-lg-0">
                        <img src="<?php echo e(asset('images/about/our-team.svg')); ?>" widht="685px" height="100%" alt="about unikwork">                        
                    </div>
                    <div class="col col-md-6">
                        <h2>Meet Our Team</h2>
                        ...
                        <a href="<?php echo e(route('careers')); ?>" class="btn button-primary mt-0">Join Our Team</a>
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.apps',['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/about.blade.php ENDPATH**/ ?>