                ...
                <div class="container cross-sec">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-12 col-xl-6 contact-form-main">
                            <form class="contact-form" id="contact_form" method="post" action="<?php echo e(route('add-contact')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="error">
                                        <?php echo e($errors->first('captchacode')); ?>
...
<?php echo $__env->make('layouts.apps',['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/contact-us.blade.php ENDPATH**/ ?>